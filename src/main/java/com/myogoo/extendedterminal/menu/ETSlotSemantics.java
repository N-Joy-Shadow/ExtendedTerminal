...
public final class ETSlotSemantics {
    public static final SlotSemantic BASIC_CRAFTING_GRID = SlotSemantics.register("BASIC_CRAFTING_GRID", false);
    public static final SlotSemantic BASIC_CRAFTING_RESULT = SlotSemantics.register("BASIC_CRAFTING_RESULT", false);

    public static final SlotSemantic ADVANCED_CRAFTING_GRID = SlotSemantics.register("ADVANCED_CRAFTING_GRID", false);
    public static final SlotSemantic ADVANCED_CRAFTING_RESULT = SlotSemantics.register("ADVANCED_CRAFTING_RESULT", false);

    public static final SlotSemantic ELITE_CRAFTING_GRID = SlotSemantics.register("ELITE_CRAFTING_GRID", false);
    public static final SlotSemantic ELITE_CRAFTING_RESULT = SlotSemantics.register("ELITE_CRAFTING_RESULT", false);

    public static final SlotSemantic ULTIMATE_CRAFTING_GRID = SlotSemantics.register("ULTIMATE_CRAFTING_GRID", false);
    public static final SlotSemantic ULTIMATE_CRAFTING_RESULT = SlotSemantics.register("ULTIMATE_CRAFTING_RESULT", false);

    public static final SlotSemantic AVARITIA_CRAFTING_GRID = SlotSemantics.register("AVARITIA_CRAFTING_GRID", false);
